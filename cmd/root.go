...
func init() {
  ...
  rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is ./luban.yaml)")
...
func initConfig() {
  ...
  viper.SetDefault("generation.output", "./generated")
